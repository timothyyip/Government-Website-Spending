  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a" style="margin-right: 0">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Testing and evaluation (in £000s)</h1>
        ...
        <table id="data">
          ...
          <tbody>
            <tr class="values">
          <g:each status="i" in="${detailsList}" var="dataSmall">
            <td>${dataSmall.testingEvaluationCosts}</td>
          </g:each>
          </tr>
          </tbody>
        </table>
        ...
        <table class="stats-table">
          ...
          <g:each status="i" in="${comments}" var="dataSmall">
            <tr class="${ (i % 2) == 0 ? 'odd' : 'even'}">
              ...
              <td >${dataSmall.testingEvaluationComment}</td>
            </tr>
          </g:each>
          </tbody>
        </table>
