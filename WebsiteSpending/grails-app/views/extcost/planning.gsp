  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a" style="margin-right: 0">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Strategy and planning cost (in £000s)</h1>
        ...
        <table id="data">
          ...
          <tbody>
            <tr class="values">
          <g:each status="i" in="${detailsList}" var="dataSmall">
            <td>${dataSmall.strategyPlanningCosts}</td>
          </g:each>
          </tr>
          <tr class="comment">
          <g:each status="i" in="${detailsList}" var="dataSmall">
            <td>${dataSmall.strategyPlanningComment}</td>
          </g:each>
          </tr>
          </tbody>
        </table>
