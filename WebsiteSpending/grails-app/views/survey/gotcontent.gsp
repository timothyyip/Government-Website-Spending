...
<html>
  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Did you get what you wanted from the site?</h1>

        <g:each status="i" in="${detailsList}" var="data">
          <table id="table${data.id}">
            <tr>
              <th>Got everything I wanted (${data.gotEveryThingIWanted}%)</th>
              <td>${data.gotEveryThingIWanted}</td>
            </tr>
            <tr>
              <th>Got most of what I wanted (${data.gotMostOfWhatIWanted}%)</th>
              <td>${data.gotMostOfWhatIWanted}</td>
            </tr>
            <tr>
              <th>Got none of what I wanted (${data.gotSomeOfWhatIWanted}%)</th>
