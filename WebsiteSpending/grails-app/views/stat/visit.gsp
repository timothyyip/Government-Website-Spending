...
<html>
  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Number of Visits</h1>
        ...
        <g:each status="i" in="${detailsList}" var="data">
          <table id="table${data.id}">
            ...
            <tbody>
                <tr>
                    <td>${data.visit_Apr_09}</td>
                    <td>${data.visit_May_09}</td>
                    <td>${data.visit_Jun_09}</td>
                    <td>${data.visit_Jul_09}</td>
                    <td>${data.visit_Aug_09}</td>
                    <td>${data.visit_Sep_09}</td>
                    <td>${data.visit_Oct_09}</td>
                    <td>${data.visit_Nov_09}</td>
                    <td>${data.visit_Dec_09}</td>
                    <td>${data.visit_Jan_10}</td>
                    <td>${data.visit_Feb_10}</td>
                    <td>${data.visit_Mar_10}</td>
                </tr>
            </tbody>
          </table>
        </g:each>
