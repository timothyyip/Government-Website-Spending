...
<html>
  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Number of Visits of at least two pages</h1>
        ...
        <g:each status="i" in="${detailsList}" var="data">
          <table id="table${data.id}">
            ...
            <tbody>
                <tr>
                    <td>${data.twoPageVisit_Apr_09}</td>
                    <td>${data.twoPageVisit_May_09}</td>
                    <td>${data.twoPageVisit_Jun_09}</td>
                    <td>${data.twoPageVisit_Jul_09}</td>
                    <td>${data.twoPageVisit_Aug_09}</td>
                    <td>${data.twoPageVisit_Sep_09}</td>
                    <td>${data.twoPageVisit_Oct_09}</td>
                    <td>${data.twoPageVisit_Nov_09}</td>
                    <td>${data.twoPageVisit_Dec_09}</td>
                    <td>${data.twoPageVisit_Jan_10}</td>
                    <td>${data.twoPageVisit_Feb_10}</td>
                    <td>${data.twoPageVisit_Mar_10}</td>
                </tr>
            </tbody>
          </table>
        </g:each>
