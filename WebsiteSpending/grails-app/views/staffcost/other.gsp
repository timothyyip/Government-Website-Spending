  ...
  <body id="details">
    ...
    <div id="content-inner-wrapper">
      <div id="module-a" style="margin-right: 0">
        <h1 class="chartTitle"><span class="chartTitle"></span><br/>Number of full-time equivalents: Other staffs</h1>
        ...
        <table class="stats-table">
          ...
          <g:each status="i" in="${comments}" var="dataSmall">
            <tr class="${ (i % 2) == 0 ? 'odd' : 'even'}">
              ...
              <td >${dataSmall.otherStaffComment}</td>
            </tr>
          </g:each>
          </tbody>
        </table>
