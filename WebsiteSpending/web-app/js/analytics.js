...
$(function () {
    jQuery.analyticEngine.init();
});

jQuery.analyticEngine = {

    init: function() {
        $("table").hide();
        $("#radio1").attr("checked", true);
        jQuery.analyticEngine.updategraph(1);
    },

    updategraph: function(id) {
        ...
        var labels = [],
            ...
            $("#table"+id+" tbody td").each(function () {
                var value = $(this).html();
                if(!value)value=0;
                data.push(value);
            });
        if(data[0]){
            ...
            bgp = r.path().attr({
                ...
                opacity: .3,
                fill: color
            }).moveTo(leftgutter + X * .5, height - bottomgutter),
            frame = r.rect(10, 10, 100, 40, 5).attr({
                fill: "#000",
                stroke: "#474747",
                "stroke-width": 2
            }).hide(),
            ...
            label[1] = r.text(60, 40, "22 September 2008").attr(txt1).attr({
                fill: color
            }).hide();
